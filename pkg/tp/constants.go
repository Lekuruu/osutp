...
func NewHitObjectType(hitObject osu.HitObject) HitObjectType {
	return NewHitObjectTypeFromString(hitObject.ObjectName, hitObject.NewCombo)
}

func NewHitObjectTypeFromString(objectType string, newCombo bool) HitObjectType {
